...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productItems = __webpack_require__(187);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function makeApiCall() {
	      ...
	      _axios2.default.get('/v1/products').then(function (response) {
	        _this2.setState({ products: _this2.state.products.concat(response.data) });
	      });
	    }
	  }, {
	    key: 'fetchProducts',
	    value: function fetchProducts(e) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_productItems2.default, { products: this.state.products })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProductItem = __webpack_require__(188);
	...
	var ProductItems = function ProductItems(props) {
	  var renderCart = props.products.map(function (product, id) {
	    return _react2.default.createElement(_ProductItem2.default, { key: id, product: product });
	  });
	  return _react2.default.createElement(
	    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactStarRatingComponent = __webpack_require__(190);
	...
	var ProductItem = function ProductItem(_ref) {
	  ...
	  var splitHighlightStr = function splitHighlightStr(highlight) {
	    ...
	    return { updateStrArr: updateStrArr, secondStrChars: secondStrChars };
	  };

	  var processNewWordStr = function processNewWordStr(data, context) {
	    if (data.indexOf(context) == -1) {
	      ...
	      return { newKey: newKey, text: text };
	    }
	  };

	  var img = './images/' + product.image;
	  return _react2.default.createElement(
	    'div',
	    { className: 'col-lg-4 col-xs-12 widget-cart card-inverse' },
	    _react2.default.createElement(
	      'div',
	      { className: 'card' },
	      _react2.default.createElement(
	        'span',
	        { className: 'search-plus-icon col-lg-12 col-xs-12' },
	        _react2.default.createElement('i', { className: 'fa fa-search-plus', 'aria-hidden': 'true' })
	      ),
	      _react2.default.createElement('img', { className: 'card-img-top img-cart', src: img }),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _typeof(processNewWordStr(product.title, 'NEW')) == "object" ? _react2.default.createElement(
	              'span',
	              { className: 'newText' },
	              processNewWordStr(product.title, 'NEW').newKey,
	              _react2.default.createElement(
	                'span',
	                { className: 'longTxt' },
	                ' - ',
	                processNewWordStr(product.title, 'NEW').text,
	                ' '
	              ),
	              ' '
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'ratings' },
	            _react2.default.createElement(_reactStarRatingComponent2.default, { name: 'samsung-shopping-rating3',
	              editing: false,
	              starCount: 5,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'span',
	              null,
	              splitHighlightStr(product.highlight).updateStrArr[0],
	              ': '
	            ),
	            _react2.default.createElement(
	              'span',
	              { className: 'srike-out' },
	              '  ',
	              splitHighlightStr(product.highlight).updateStrArr[1],
	              ' '
	            ),
	            _react2.default.createElement(
	              'span',
	              null,
	              '  / ',
	              splitHighlightStr(product.highlight).secondStrChars
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          null,
	          ' ',
	          product.available_sizes.length == 1 ? _react2.default.createElement(
	            'div',
	            { className: 'size-text' },
	            ' ',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '/', className: 'btn-demo btn-block btn-cart' },
	          'ADD TO CART'
	        )
	      )
	    )
